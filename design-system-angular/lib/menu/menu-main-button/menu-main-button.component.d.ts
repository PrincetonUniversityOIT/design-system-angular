...
export declare class MenuMainButtonComponent implements OnInit {
    ...
    getMenuText(): string;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<MenuMainButtonComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<MenuMainButtonComponent, "jazz-menu-main-button", never, { "buttonClass": "buttonClass"; "showCompact": "showCompact"; }, {}, never, never>;
}
